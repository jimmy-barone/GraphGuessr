A sample of server-side scripts from a Roblox graph-guessing game. The objective of the game is exactly as it sounds: players are shown the graph of an equation in ℝ², or the graph of a surface in ℝ³,
